...
public class BtPairConnectActivity extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (DEBUG)
			Log.d(TAG, "onCreate");
		mCheckedItems=Utils.getCheckedItems(this);
						...
						if (which == DialogInterface.BUTTON_POSITIVE) {
							Log.d(TAG, "BUTTON_POSITIVE Clicked " );	
							 for (int i = 0; i < mConnectItems.length; i++) {
								...
								Utils.setCheckedItems(BtPairConnectActivity.this,mCheckedItems);
								if(mCheckedItems[i]){
				...
				new DialogInterface.OnMultiChoiceClickListener() {
					public void onClick(DialogInterface dialog, int which, boolean isChecked) {
						...
						/*if(isChecked == true){
							...
							Toast.makeText(getApplicationContext(), "Connecting Bluetooth device",Toast.LENGTH_LONG).show();
						}
						else{
						    mDevice.disconnectProfileName(mConnectItems[which].toString());
							Toast.makeText(getApplicationContext(), "Disconnecting Bluetooth device",Toast.LENGTH_LONG).show();
						}*/
	...
	private OnItemClickListener mOperationsClickListener = new OnItemClickListener() {
		public void onItemClick(AdapterView<?> av, View v, int arg2, long arg3) {
			...
			HashMap<String, Object> operationsInfo = mOperationsList.get(arg2);
				...
				if(operations_name.equals(getString(R.string.trypair_bt_string)) ){
                    ...
                    if (mDevice != null) {
                        if (mDevice.getBondState() == BluetoothDevice.BOND_BONDED) {
                           ...
                           /* Toast.makeText(getApplicationContext(),
                                    "The Bluetooth device is unbondedcd already", Toast.LENGTH_LONG)
                                    .show();*/
                        }
                    }
   ...
   //     Toast.makeText(getApplicationContext(), mSelectedDevice.getName() + " : type = " + type,Toast.LENGTH_LONG).show();
